...
import { MagnifyingGlass, CircleNotch, CaretDown, Info } from '@phosphor-icons/react';
...
export function PincodeFinder({ onSelect, onClose, align = 'right' }: PincodeFinderProps) {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'absolute z-[9999] top-full mt-1.5 w-80 rounded-2xl border border-border/60 bg-card shadow-2xl shadow-black/15 overflow-hidden',
